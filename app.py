...
class UserInput(BaseModel):
    ...
    smoker: Annotated[bool, Field(..., description="Is the user a smoker?", example='no')]
    city: Annotated[str, Field(..., description="City of the user", example="New York")]
    occupation: Annotated[Literal['retired', 'freelancer', 'student', 'government_job',
       'business_owner', 'unemployed', 'private_job'], Field(..., description="Occupation of the user", example="Software Engineer")]
